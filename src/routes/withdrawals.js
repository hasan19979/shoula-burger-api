...
// GET /api/withdrawals?from=YYYY-MM-DD&to=YYYY-MM-DD — سجل السحوبات، بترتيب الأحدث أول
...
router.post('/', requireAnyAuth, asyncHandler(async (req, res) => {
  ...
  const result = await pool.query(
    'INSERT INTO cash_withdrawals (amount, reason, staff_name) VALUES ($1, $2, $3) RETURNING *',
    [numAmount, reason || '', staffName]
  );
